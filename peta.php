    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">Unduh Peta Evakuasi</h1>
        </div>
        <!-- breadcrumbs -->
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Unduh Peta Evakuasi</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
              ...
              <?php
                      ...
                      while ($data = mysqli_fetch_array($hasil)) {
                          ...
                          <tr>
                              ...
                              <td><img src="img/<?= $data["gambar"]; ?>" width="250"></td>
                              <td><a href="download.php?file=<?php echo $data["gambar"]; ?>" target="_blank" class="btn btn-primary" role="button">Unduh Peta></a></td>
                          </tr>
                          </tbody>
                          <?php
                      }
          ...
          <div align="right">
              <a href="lokasi.php" class="btn btn-danger">Kembali</a>
          </div>
        </div>
      </div>
    </div>
