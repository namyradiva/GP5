...
<!DOCTYPE html>
    <html lang="en">
      ...
      <body>
        ...
        <div class="container-fluid">
          ...
          <div align="left">
            <div class="card border-light" style="width: 30rem;">
              <div class="card-body">
                <h3 class="card-text mb-4"><strong>Titik Evakuasi</strong></h3>
              </div>
            </div>
          </div>
        ...
        <div class="container-fluid">
              <div align="right">
                <a href="tambah.php" class="btn btn-success mb-3"><i class="fa-solid fa-plus"></i> Tambah Data</a>
              </div>
            <!-- Content Row -->
            <div class="row">
            <table class="table table-bordered table-hover border">
                    ...
                    while ($data = mysqli_fetch_array($hasil)) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $data["titik"];   ?></td>
                            <td><?php echo $data["keterangan"];   ?></td>
                            <td>
                                <a href="ubah.php?id=<?php echo htmlspecialchars($data['id']); ?>" class="btn btn-warning" role="button">Ubah</a>
