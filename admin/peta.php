    ...
    <html lang="en">
      ...
      <body>
        ...
        <div class="container-fluid">
          ...
          <div align="left">
            <div class="card border-light" style="width: 30rem;">
              <div class="card-body">
                <h3 class="card-text mb-4"><strong>Peta Evakuasi</strong></h3>
              </div>
            </div>
          </div>
        ...
        <div class="container-fluid">
              ...
              <div align="right">
                <a href="uploadpeta.php" class="btn btn-success mb-3"><i class="fa-solid fa-plus"></i> Upload Peta</a>
              </div>
            <!-- Content Row -->
            <div class="row">
            <table class="table table-bordered table-hover border">
                    ...
                    while ($data = mysqli_fetch_array($hasil)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="hapus_peta.php?id=<?php echo $data['id_file']; ?>" class="btn btn-danger" role="button">Hapus</a>
                            </td>
                        </tr>
                        </tbody>
                        <?php
